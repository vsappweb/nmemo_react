                    ...
                    <form className="gmToolsFormForm" onSubmit={submitHandler}>
                        <div className="gmToolsFormOptionsWrapper">
                            ...
                            <label htmlFor="gmToolsForm" className="gmToolsFormOption photoAnchor">
                                <h4 className="gmToolsFormItemTitle" style={{ color: "orangeRed" }} >Problem:</h4>
                                <textarea className="gmToolsFormTextarea" ref={problem} required />
                            </label>

                            <label htmlFor="gmToolsForm" className="gmToolsFormOption">
                                <h4 className="gmToolsFormItemTitle" style={{ color: "green" }} >How we fix it:</h4>
                                <textarea className="gmToolsFormTextarea" ref={howFix} required />
                            </label>
