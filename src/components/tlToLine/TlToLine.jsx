...
export default function TlToLine() {
  ...
  const submitHandler = async (e) => {
    ...
    const newtlToLine = {
      ...
      timer:
        new Date(endTime.current.value).toLocaleDateString("nl-NL") +
        " " +
        new Date(endTime.current.value).toLocaleTimeString("nl-NL"),
      ...
      <div className="tlToLineWrapper">
        <div className="tlToLinechooseBoxCapton">
          ...
          <label htmlFor="tlToLineReqRes" className="tlToLineReqRes">
            <p className="tlToLineRequestResponse">
              Response <br /> request
            </p>
            <input
              type="checkbox"
        ...
        <form className="tlToLineBottom" onSubmit={submitHandler}>
          ...
          <button className="tlToLineButton" type="submit">
            Send
            <DoneOutline />
          </button>
        </form>
