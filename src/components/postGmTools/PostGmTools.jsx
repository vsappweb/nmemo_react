      ...
      <div className="postWrapper">
        <div className="postTop">
          <div className="postTopLeft">
            <span className="postGmToolsTitle" style={{ color: "blue" }}>
              {gmTool?.toolNumber}
            </span>
          </div>
          <div className="postTopRight">
            <span className="postDate">
              {gmTool.date} {format(gmTool.createdAt)}
            </span>
            {isMenuOpen && (
        ...
        <div className="postCenter">
          <h3 className="postGmToolsTitle" style={{ color: "orangered" }}>
            Problem was:{" "}
            <span
              style={{
                color: "red",
          ...
          <h3 className="postGmToolsTitle" style={{ color: "green" }}>
            How we fixed it:
          </h3>
