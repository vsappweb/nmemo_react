...
export default function Messenger() {
  ...
  const showchatMenu = () => {
    ...
    document
      .querySelector(".chatMenuBurgerLineThree")
        ...
        <div className="chatMenu">
          <div className="chatMenuWrapper">
            <div className="chatMenuAddNew">
              ...
              <div
                className={`chatMenuDropdown ${open ? "active" : "inactive"}`}
              >
