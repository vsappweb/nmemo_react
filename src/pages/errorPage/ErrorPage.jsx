      ...
      <div className='safety'>
        <div className="safetyRight">
          <div className="underDevelopmentContainer">
            ...
            <br />
            <h3 className="underDevelopmentTitle"><span style={{ fontSize: "50px", fontWeight: "bold", color: "grey" }}>404</span> - Page Not Found</h3>
            <br />
            <h3 className="underDevelopmentSubtitle">Sorry, the page you are looking for could not be found.</h3>
            <br />
            <h3 className="underDevelopmentSubtitle">Please check the URL and try again.</h3>
            <br />
            <br />
            <Link to="/" style={{ textDecoration: "none" }}>
              <h3 className="underDevelopmentTitle">Or go to <span>Home page</span></h3>
            </Link>
          </div>
        </div>
      </div>
